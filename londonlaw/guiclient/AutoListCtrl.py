...
class AutoListCtrl(AutoWidthListCtrl, ColumnSorterMixin):
   ...
   def populateList(self):
      ...
      for i in list(range(len(self.headers) - 1)):
...
#            self.GetItemText(i)
   ...
   def addItem(self, data):
      ...
      foundMatch = False
      for item in list(range(len(self.itemDataMap))):
   ...
   def removeItemByData(self, data):
      for key in self.itemDataMap:
         if self.itemDataMap[key][0] == data[0]:
            # update the datamap 
            for i in list(range(key, len(self.itemDataMap)-1)):
      ...
      for item in list(range(self.GetItemCount())):
      ...
      for item in list(range(len(self.itemDataMap))):
         for key in list(range(len(self.itemDataMap))):
